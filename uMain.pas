  ...
  if ARequestInfo.Command = 'POST' then
      begin
         ...
         if assigned(Stream) then
            begin
               //Stream.Position := 0;
               fs := TFileStream.Create('temp.bas', fmCreate or fmOpenWrite);
               fs.Write(Stream, 0);
  ...
  try
    ...
    try
      ...
      try
        ...
        try
          //IdHTTP.Post2('https://esm-db.eu/esmws/eventdata/1/query?eventid=IT-1997-0004&station=CLF&format=ascii', Params, LOutFile);
